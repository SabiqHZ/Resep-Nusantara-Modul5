          ...
          return (
            ...
            >
              ...
              <div className="relative bg-white/15 backdrop-blur-xl border border-white/25 rounded-2xl md:rounded-3xl overflow-hidden shadow-lg md:shadow-2xl shadow-blue-500/5 hover:shadow-blue-500/15 transition-all duration-500 cursor-pointer group-hover:scale-105 group-hover:bg-white/20">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-white/5 via-transparent to-blue-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10" />
                ...
                >
                  ...
                  <p className="font-semibold text-yellow-300 mb-1">Bahan:</p>
                  <ul className="list-disc text-left text-gray-200 mb-3 ml-4">
                    {recipe.ingredients.slice(0, 4).map((bahan, i) => (
                      <li key={i}>{bahan}</li>
                    ))}
                  </ul>
                  <p className="font-semibold text-yellow-300 mb-1">Langkah:</p>
